require(['config'],function(){
    require(['jquery','common'],function($){
        ...
        // var $lis =  $('.com_b').children('li');
        // $lis.each(function(idx,item){
        //     var $img = $lis.eq(idx).find('img');
        //     $img.on('mouseover',function(){
        //         $img.animate({width:400,height:300}, 1000);
        //     });
        // });
        ...
        Carousel.prototype.stop = function(){
         ...
         new Carousel({
            ...
            height:415,
            type:'horizontal',
            imgs:["../src/img/pic1.jpg","../src/img/pic2.jpg","../src/img/pic3.jpg","../src/img/pic4.jpg","../src/img/pic5.jpg","../src/img/pic6.jpg","../src/img/pic7.jpg","../src/img/pic8.jpg"]
         });
    });
});